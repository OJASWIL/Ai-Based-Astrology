...
// importing the signup form component that has name, email and password fields
...
// this is the signup page — new users come here to create a new account
      ...
      <main className="min-h-screen flex items-center justify-center pt-16 px-4 py-12">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold gradient-text mb-2" suppressHydrationWarning>
              {t("signup.title")}
            </h1>
          ...
          {/* the actual signup form with name, email and password fields */}
          <SignupForm />

          {/* link at the bottom for users who already have an account */}
          <p className="text-center text-sm text-muted-foreground mt-6" suppressHydrationWarning>
            {t("signup.hasAccount")}{" "}
            {/* clicking this link takes the user to the login page */}
